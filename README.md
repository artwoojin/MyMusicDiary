...
| <p align="left">- 유저 CRUD <br/>- JWT 이용 로그인 <br/> - 좋아요, 태그 <br/>- AWS EC2 배포 <br/>- AWS RDS,MySQL 데이터베이스 <br/></p> |      <p align="left">- 다이어리 CRUD <br/>- 댓글 CRUD <br/>- 플레이리스트 CRUD <br/>- AWS EC2 배포, https 적용 <br/>- AWS RDS,MySQL 데이터베이스 <br/></p>       | <p align="left">- 플레이리스트 CRUD<br/>- 다이어리/댓글 CRUD<br/>- UX 사용성 개선<br/>- 다이어리 <br/>- 페이지네이션<br/>- 다크모드</p>|
<br/>
